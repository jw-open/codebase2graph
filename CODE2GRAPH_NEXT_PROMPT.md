...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T045100Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T043054Z.json`
