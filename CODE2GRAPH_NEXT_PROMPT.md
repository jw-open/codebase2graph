...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T121315Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T115309Z.json`
