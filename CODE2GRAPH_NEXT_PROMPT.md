...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T093226Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T091220Z.json`
