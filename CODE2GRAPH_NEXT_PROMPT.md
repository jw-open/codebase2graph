...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T081202Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T075156Z.json`
