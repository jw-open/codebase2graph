...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T073149Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T071143Z.json`
