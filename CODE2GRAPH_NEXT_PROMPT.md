...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T143351Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T141345Z.json`
