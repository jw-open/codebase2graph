...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T151403Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T145357Z.json`
