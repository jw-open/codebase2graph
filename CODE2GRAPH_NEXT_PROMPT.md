...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T034801Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T034203Z.json`
