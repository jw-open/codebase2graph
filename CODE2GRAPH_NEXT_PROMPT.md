...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T041048Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T035132Z.json`
