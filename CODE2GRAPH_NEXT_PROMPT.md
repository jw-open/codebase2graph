...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T101238Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T095232Z.json`
