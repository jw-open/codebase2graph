...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T051106Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T045100Z.json`
