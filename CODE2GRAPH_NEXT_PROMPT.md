...
- Graph type: `all`
- Current snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T065137Z.json`
- Previous snapshot: `.code2graph-runs/claude-code-source-code.all.20260524T063131Z.json`
